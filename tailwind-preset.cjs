...
module.exports = {
  ...
  'dark:bg-[var(--color-foreground)]/70',
  'dark:hover:bg-[var(--color-error)]/20',
  'from-[var(--color-primary)]/5',
  'group-hover:bg-[var(--color-foreground)]/20',
  'group-hover:text-[var(--color-primary)]',
  'hover:bg-[var(--color-error)]/10',
  'hover:bg-[var(--color-muted)]/50',
  'hover:bg-[var(--color-muted)]/80',
  'hover:bg-[var(--color-muted-foreground)]/15',
  'hover:bg-[var(--color-primary)]/10',
  'hover:border-l-[var(--color-muted)]',
  'hover:text-[var(--color-background)]',
  'peer-focus:ring-[var(--color-error)]/20',
  'peer-focus:ring-[var(--color-ring)]/20',
  'ring-[var(--color-accent)]/20',
  'ring-[var(--color-error)]/20',
  'ring-[var(--color-info)]/20',
  'ring-[var(--color-muted-foreground)]/20',
