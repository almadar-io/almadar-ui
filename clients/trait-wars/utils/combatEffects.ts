...
// Animation keyframes (to be added to global CSS or tailwind config)
...
// CSS class utilities for combat effects
export const combatClasses = {
    ...
    // Tailwind built-in alternatives
    hit: 'animate-pulse brightness-150',
    defend: 'animate-bounce',
    critical: 'animate-ping',
};

// Effect configuration for different combat events
...
export const combatEffects: Record<string, CombatEffect> = {
    attack: {
        className: 'animate-pulse brightness-125',
        duration: 300,
    },
    hit: {
        className: 'animate-[shake_0.3s_ease-in-out] brightness-150',
        duration: 300,
    },
    critical: {
        className: 'animate-ping scale-110',
        duration: 500,
    },
    defend: {
        className: 'animate-bounce ring-4 ring-blue-400',
        duration: 400,
    },
    heal: {
        className: 'brightness-125 ring-4 ring-green-400',
        duration: 600,
    },
    defeat: {
        className: 'grayscale opacity-50 scale-75',
        duration: 800,
    },
    levelUp: {
        className: 'animate-bounce ring-4 ring-yellow-400 brightness-150',
        duration: 1000,
    },
};

// Apply temporary effect to an element
