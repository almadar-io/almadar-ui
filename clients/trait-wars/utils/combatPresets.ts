...
function p(manifest: TraitWarsAssetManifest, key: string): string[] {
    const particles = manifest.effects?.particles;
    if (!particles) return [];
...
function anim(manifest: TraitWarsAssetManifest, key: string): string[] {
    const animations = manifest.effects?.animations;
...
/**
 * Create combat preset factories from an asset manifest.
 */
export function createCombatPresets(
    ...
    return {
        ...
        // =====================================================================
        // DEFEND — star (blue) + circle (blue, pulse)
        // =====================================================================
