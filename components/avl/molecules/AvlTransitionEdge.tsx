  ...
  return (
    <>
      ...
      <EdgeLabelRenderer>
        ...
        >
          {data?.hasGuard && (
            <div className="w-3 h-3 rotate-45 border border-warning bg-warning/10 shrink-0" title={t('avl.guard')} />
          )}
          ...
          {data?.hasEffects && (
            <div className="w-2.5 h-2.5 rounded-full bg-primary shrink-0" title={t('avl.effects')} />
          )}
        </div>
      </EdgeLabelRenderer>
    </>
