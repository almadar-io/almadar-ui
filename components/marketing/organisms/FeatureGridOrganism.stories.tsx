...
import { FeatureGridOrganism, type FeatureRow } from './FeatureGridOrganism';

const MOCK_FEATURES: readonly EntityWith<FeatureRow>[] = [
  {
    id: '1',
    icon: 'shield-check',
    title: 'Core/Organisms/FeatureGridOrganism',
