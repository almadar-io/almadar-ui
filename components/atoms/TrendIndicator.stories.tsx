  ...
  render: () => (
    <div className="space-y-3">
      <div className="flex items-center gap-3">
        <span className="text-sm text-[var(--color-foreground)] w-24">Error rate:</span>
        <TrendIndicator value={-15.2} invert label="Error rate down 15.2%" />
        <span className="text-xs text-[var(--color-muted-foreground)]">(down is good)</span>
      </div>
      <div className="flex items-center gap-3">
        <span className="text-sm text-[var(--color-foreground)] w-24">Bounce rate:</span>
        <TrendIndicator value={3.1} invert label="Bounce rate up 3.1%" />
        <span className="text-xs text-[var(--color-muted-foreground)]">(up is bad)</span>
      </div>
    </div>
  ),
};
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between p-4 rounded-lg bg-[var(--color-surface)] border border-[var(--color-border)] w-64">
        <div>
          ...
          <div className="text-2xl font-bold text-[var(--color-foreground)]">$12,450</div>
        </div>
      ...
      <div className="flex items-center justify-between p-4 rounded-lg bg-[var(--color-surface)] border border-[var(--color-border)] w-64">
        <div>
          ...
          <div className="text-2xl font-bold text-[var(--color-foreground)]">3,241</div>
        </div>
        <TrendIndicator value={-2.1} />
      </div>
      <div className="flex items-center justify-between p-4 rounded-lg bg-[var(--color-surface)] border border-[var(--color-border)] w-64">
        <div>
          <div className="text-xs text-[var(--color-muted-foreground)]">Conversion</div>
          <div className="text-2xl font-bold text-[var(--color-foreground)]">4.2%</div>
        </div>
