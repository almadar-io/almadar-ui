...
const MOCK_FULL: PricingPageEntity = {
  ...
  plans: [
    ...
    },
    {
      ...
      action: { label: 'Start Trial', href: '/signup?plan=pro' },
      highlighted: true,
      badge: 'Most Popular',
    },
    {
...
const MOCK_NO_FAQ: PricingPageEntity = {
  ...
  plans: [
    ...
    },
    {
      ...
      action: { label: 'Start Trial', href: '/signup?plan=team' },
      highlighted: true,
      badge: 'Best Value',
    },
  ],
...
const MOCK_WITH_CTA: PricingPageEntity = {
  ...
  plans: [
    ...
    },
    {
      ...
      action: { label: 'Subscribe', href: '/signup?plan=growth' },
      highlighted: true,
    },
    {
      id: 'scale',
      ...
      action: { label: 'Subscribe', href: '/signup?plan=scale' },
    },
  ],
