...
const DEFAULT_3D_BATTLE_LAYOUT: Tile3DLayout[] = [
...
export function GameCanvas3DBattleTemplate({
    ...
    const tiles = hasEntityTiles
        ...
        : propTiles
            ...
            : resolveTilesWithModels(DEFAULT_3D_BATTLE_LAYOUT, assetManifest);
    ...
    const currentTurn = row?.currentTeam == null ? undefined : (String(row.currentTeam) as 'player' | 'enemy');
    const round = row?.turn == null ? undefined : Number(row.turn);
